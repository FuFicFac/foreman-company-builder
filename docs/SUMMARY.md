...
- [Single-Provider Setup](single-provider.md)
- [Multi-Provider Fleet](multi-provider-fleet.md)
- [Deluxe Loop for High-Stakes Work](deluxe-loop.md)

## Reference

- [CLI Inventory Template](cli-inventory-template.md)
